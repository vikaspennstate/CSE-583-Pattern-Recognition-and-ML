...
M=9; % number of coefficients
wstar = GetWStar(x,t,M); % we get the value of w for which the error is minimum
adjust = AdjustCoeff(x,wstar);   % we adjust the coefficients along wirh x values to get y values
